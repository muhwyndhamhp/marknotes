...
func PostForm(post models.Post) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form id=\"form-post\"><label><h2>Put your toughts here</h2></label><br><input placeholder=\"Blog title goes here...\" class=\"bg-stone-50 dark:text-slate-800 p-24 font-mono focus:border-transparent focus:outline-none focus:outline-sky-600 border-transparent shadow-2xl shadow-rose-800/30 w-10/12 p-3 rounded-t-lg mt-0\" type=\"text\" name=\"title\"")
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" hx-push-url=\"true\" hx-target=\"#admin-root\" class=\"focus:border-transparent focus:outline-nonefocus:outline-sky-600 w-1/5 border-transparent bg-white py-4 my-3 drop-shadow-md text-indigo-800 border-none rounded-xl mx-2\">Cancel</button>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
