...
func new(existingPost *models.Post, baseURL, uploadURL string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form id=\"form-post\" class=\"mt-6 w-full h-full flex flex-col md:flex-row-reverse max-w-screen-itn2 mx-auto\"><div class=\"flex flex-col\"><div class=\"box-border\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if existingPost != nil {
