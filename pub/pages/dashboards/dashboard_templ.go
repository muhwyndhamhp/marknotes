...
func drawer(items []pub_variables.DrawerMenu, breadcrumbs []pub_variables.Breadcrumb, comp templ.Component, navItems ...templ.Component) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for i := range breadcrumbs {
			...
			var templ_7745c5c3_Var5 templ.SafeURL = breadcrumbs[i].URL
			...
			templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(breadcrumbs[i].Label)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pub/pages/dashboards/dashboard.templ`, Line: 64, Col: 77}
			}
...
func drawerItem(item pub_variables.DrawerMenu) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var10 = []any{"group", templ.KV("active", item.IsActive)}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pub/pages/dashboards/dashboard.templ`, Line: 125, Col: 15}
		}
