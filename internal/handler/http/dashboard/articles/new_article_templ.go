...
func new(existingPost *internal.Post, baseURL, uploadURL string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form id=\"form-post\" class=\"mt-6 w-full h-full flex flex-col md:flex-row-reverse max-w-screen-itn2 mx-auto\"><div><div class=\"box-border md:min-h-60 sticky top-20\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if existingPost != nil {
			...
			templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs("/dashboard/analytics/" + existingPost.Slug)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 35, Col: 57}
			}
		...
		templ_7745c5c3_Err = submitButton(tern.Struct(existingPost, &internal.Post{}).ID).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div></div></div><div class=\"flex flex-col items-start w-full md:ps-8 overflow-x-clip\"><div class=\"w-full md:max-w-xl itn:max-w-2xl itn2:max-w-3xl xl:max-w-4xl\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		var templ_7745c5c3_Var4 = []any{"w-[98%] mx-auto min-h-20 card bg-base-100/40 outline-dashed outline-secondary",
			templ.KV(
				"outline-transparent",
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 1, Col: 0}
		}
		...
		templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf(`
               ...
               `, uploadURL))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 82, Col: 28}
		}
		...
		var templ_7745c5c3_Var7 = []any{"w-full h-full relative max-h-56",
			templ.KV(
				"hidden",
				existingPost == nil || existingPost.HeaderImageURL == "",
			)}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><img class=\"w-full h-full object-cover max-h-56\" src=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var9 string
		templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(HeaderURL(existingPost))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 107, Col: 36}
		}
		...
		var templ_7745c5c3_Var10 = []any{"text-2xl font-bold text-center mx-auto my-auto text-primary",
			templ.KV(
				"hidden",
				existingPost != nil && existingPost.HeaderImageURL != "",
			)}
		...
		if existingPost != nil {
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(existingPost.Title)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 133, Col: 26}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 141, Col: 16}
		}
		...
		if existingPost != nil {
			...
			templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(string(existingPost.EncodedContent))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 155, Col: 49}
			}
		...
		if existingPost != nil {
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(existingPost.HeaderImageURL)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 164, Col: 41}
			}
		...
		if existingPost != nil {
			...
			templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(TagsToCommaSeparated(existingPost.Tags))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 173, Col: 53}
			}
		...
		if existingPost != nil {
			...
			templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(string(existingPost.Status))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 182, Col: 41}
			}
...
func submitButton(existingID uint) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex flex-col sm:flex-row md:flex-col md:justify-center px-6 md:px-12 pb-6 w-full items-center justify-evenly\"><button id=\"publish-button\" class=\"btn btn-primary mt-3 md:mt-0 md:max-w-72 lg:max-w-64 xl:max-w-72 btn-block sm:btn-wide mx-3 md:mx-0\" hx-post=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var19 string
		templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/dashboard/articles/push?status=published&existingID=%d", existingID))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 198, Col: 95}
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" hx-vals=\"js:{\n        content_json: window.editor.getJSON(),\n        markdown_content: editor.storage.markdown.getMarkdown()\n        }\" hx-indicator=\"#global-progress\">Publish</button> <button id=\"draft-button\" class=\"btn btn-secondary mt-3 md:max-w-72 lg:max-w-64 xl:max-w-72 btn-block sm:btn-wide mx-3 md:mx-0\" hx-post=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		var templ_7745c5c3_Var20 string
		templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/dashboard/articles/push?status=draft&existingID=%d", existingID))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/handler/http/dashboard/articles/new_article.templ`, Line: 217, Col: 91}
		}
